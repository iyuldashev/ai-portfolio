...
const questions = {
  ...
  Research: 'What research have you published? Tell me about your academic work.',
...
const questionConfig = [
  ...
  { key: 'Research', color: '#E67E22', icon: GraduationCapIcon },
...
const questionsByCategory = [
  ...
  },
  {
    ...
    questions: [
      ...
      'What conferences have you presented at?',
    ],
  },
  {
    id: 'fun',
    ...
    icon: PartyPopper,
    questions: [
      'Show me your hiking adventures!',
      "What's the most adventurous thing you've done?",
      'Mac or PC?',
      'What do you do for fun in South Korea?',
    ],
  },
  {
    id: 'contact',
              ...
              >
                {questionConfig.map(({ key, color, icon: Icon }) => (
                  <Button
                    ...
                    variant="outline"
                    className="border-border hover:bg-border/30 h-auto min-w-[90px] flex-shrink-0 cursor-pointer rounded-xl border bg-white/80 px-3 py-3 shadow-none backdrop-blur-sm transition-none active:scale-95"
                  >
