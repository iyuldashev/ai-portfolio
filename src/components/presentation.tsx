...
export function Presentation() {
  ...
  const profile = {
    ...
    description:
      "Hey 👋\nI'm Izzatillo, an AI/ML Engineer with hands-on experience in training and deploying LLMs, developing NLP solutions, and integrating AI models into real-world applications. Recently completed my Master's in Computer Engineering at Pukyong National University.",
    src: '/profil-izzat.png',
    fallbackSrc:
    ...
    <div className="mx-auto w-full max-w-5xl py-6 font-sans">
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col space-y">
          ...
          >
            {['AI/ML Engineer', 'NLP', 'LLMs', 'Research', 'PyTorch'].map(
              (tag) => (
                <span
                  key={tag}
